...
class routing_domain(resource.Resource):
    ...
    def __init__(self, name, json_snippet, stack):
        super(routing_domain, self).__init__(name, json_snippet, stack)
    ...
    def handle_create(self):
        ...
        routing_domain = client.create_routing_domain({'routing_domain': props})['routing_domain']
...
def resource_mapping():
    ...
    return {
        'OS::Neutron::routing_domain': routing_domain,
     }
